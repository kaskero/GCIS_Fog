...
def eliminar_componentes(componentes, replicas): # Ya no borrará deployments.
	cliente=client.CustomObjectsApi()

	# Hace falta añadir que borre los componentes según número de replicas.
	for i in componentes:
		cliente.delete_namespaced_custom_object(grupo, 'v1alpha1', namespace, 'componentes', 'componente'+'-'+i['name'])
